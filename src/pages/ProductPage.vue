...
export default {
  data() {
    return {
      ...
      currentSizeId: 0,
      productData: null,
      selectedColor: +this.$route.params.colorId,
  ...
  watch: {
    ...
    selectedColor(value) {
      this.$route.query.color = null;
      this.$router.push({ name: 'product', params: { id: this.product.id }, query: { color: value } });
    },
    productAmount() {
      if (this.productAmount === 0 || this.productAmount === '') this.productAmount = 1;
    },
  },
  mounted() {
